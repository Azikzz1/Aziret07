...
async def edit_products(call: types.CallbackQuery, state: FSMContext):
    ...
    model_name_button = InlineKeyboardButton(text="Название модели", callback_data="field_model_name")
    size_1_button = InlineKeyboardButton(text="Размер", callback_data="field_size_1")
    price_button = InlineKeyboardButton(text="Стоимость", callback_data="field_price")
    ...
    keyboard.add(model_name_button, category_button, price_button, size_1_button, photo_button, info_button, collection_button)
